...
print(shadoof_by_Piter, shadoof_by_Serg, shadoof_by_Kate)
...
#Сумма первых трех чисел в билете
a = sum(map(int,str(321)))

#Сумма последних трех чисел в билете
b = sum(map(int,str(123)))
